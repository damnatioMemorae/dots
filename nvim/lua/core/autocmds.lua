...
api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(args)
                ...
                map("gr", vim.lsp.buf.references, " Goto Implementation")
                map("gI", vim.lsp.buf.incoming_calls, "Incoming calls")
                map("gc", vim.lsp.buf.code_action, "󱠀 Code Action")
                map("ga", function() require("functions.quickfix").code_actions() end, "󱠀 Quickfix")
