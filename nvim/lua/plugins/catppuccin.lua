...
local customCol = function(C)
        return {
                ...
                GitSignsChange                   = { fg = "#7c7157", bg = C.crust },
                ...
                ["@keyword.conditional"]         = { fg = C.sapphire },
                ["@keyword.repeat"]              = { fg = C.sapphire },
                ["@class"]                       = { fg = C.teal },
                ...
                LspInlayHint                     = { fg = C.surface2, bg = C.base },
