...
const float BRIGHT_GLOW = 0.22; // Glow intensity for bright pixels
const float COLOR_GLOW = 0.8; // Color bleeding intensity

// Scanline Settings
const float SCANLINE_INTENSITY = 1.3; // Overall intensity of scanlines
const float SCANLINE_DENSITY = 0.6; // Density/thickness of scanlines
